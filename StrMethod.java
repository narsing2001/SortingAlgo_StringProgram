...
*/
  ...
  // boolean contains(CharSequence sequence) Method 
        ...
        System.out.println("hashcode of FB:"+"FB".hashCode());
        System.out.println("hashcode of Ea:"+"Ea".hashCode());
        
        System.out.println("FB and Ea has same hashcode:"+("FB".hashCode()=="Ea".hashCode()));
        ...
        System.out.println("AaBB".hashCode()); // 2031744
        System.out.println("BBAa".hashCode()); // 2031744
        
/*
1️. Hash Collision Definition:A hash collision occurs when:
------------------------------------------------------------
Two different objects produce the same hashCode.

Different content + same hashCode → collision ✅

Same content + same hashCode → not a collision ❌ 
*/
